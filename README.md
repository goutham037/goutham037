...
| [GSPT — GRIET Portal MCP Server](https://github.com/goutham037/gspt) | Playwright scraper for a college portal exposed as an MCP server — zero-credential tools let ChatGPT pull live attendance/timetable/library data without a password ever touching the prompt | Python · FastMCP · Playwright · Streamable-HTTP |
